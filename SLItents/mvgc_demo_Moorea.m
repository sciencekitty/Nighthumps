...
for i = 1:length(files)
    ...
    for ii = 1:3
        ...
        X = [manta.DOXY(:,ii),manta.moon,manta.TF,manta.Hum,manta.Pres,manta.Wind,manta.WindDir];

        times=datetime(manta.SDN,'ConvertFrom','datenum');
        vars={'DOXY','moon','TF','Hum','Pres','Wind','WindDir','WindGur','WaveHt','WavePd','Cloud'};
...
for i = 1:length(files)
    ...
    for ii = 1:5
        ...
        X = [manta.DOXY(:,ii),manta.moon,manta.TF,manta.Hum,manta.Pres,manta.Wind,manta.WindDir,...
            manta.WindGur,manta.WaveHt,manta.WavePd,manta.Cloud];
